...
[TenDaysWeather(date: "오늘", weather: "sun", humidity: 0, minTemp: 15, maxTemp: 23),
 TenDaysWeather(date: "화", weather: "heavyRain", humidity: 60, minTemp: 18, maxTemp: 27),
 TenDaysWeather(date: "수", weather: "heavyRain", humidity: 60, minTemp: 20, maxTemp: 25),
 TenDaysWeather(date: "목", weather: "heavyRain", humidity: 70, minTemp: 19, maxTemp: 23),
